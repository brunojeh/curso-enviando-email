...
public class ObjetoEnviaEmail {
	...
	private String userName = "brunoareda.caldeira@gmail.com";
	private String senha = "gfx512mb";
	...
	public void enviarEmail(boolean envioHtml) throws Exception {
		...
		properties.putIfAbsent("mail.smtp.ssl.trust", "*");
	...
	public void enviarEmailAnexo(boolean envioHtml) throws Exception {
		...
		anexoEmail.setFileName("anexomail"+index+".pdf");
	 ...
	 * 
	 * Retorna um PDF em branco com o textoo do paragrafo de exemplo
	 * */
	private FileInputStream simuladorDePDF() throws Exception{
		Document document = new Document();
		File file = new File("fileanexo.pfd");
		file.createNewFile();
